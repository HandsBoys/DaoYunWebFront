...
export default {
  ...
  data() {
    return {
      // 左侧菜单数据
      menuList: [
        {id:"125",authName:"用户管理",children: [{id:"1255",authName:"用户列表",path:"UserList"}]},
        {id:"103",authName:"角色管理"},
        {id:"101",authName:"菜单管理"},
        {id:"102",authName:"班课管理"},
        {id:"145",authName:"字典管理"},
      ],
      // 一级菜单图标对象
      iconsObj: {
  ...
  mounted() {
    const container_h = window.screen.height / 1.25;
    document
      .querySelector(".home-container")
      .setAttribute("style", "height:" + container_h + "px;");
  },
  methods: {
    quit: function() {
