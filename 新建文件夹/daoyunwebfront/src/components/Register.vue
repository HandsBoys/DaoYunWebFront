    ...
    <div class="regmain">
      <div class="regbox">
        ...
        <div class="regbox3">
          ...
          <el-tooltip class="item" effect="dark" content="密码为6-16位，包括至少1个大写字母，1个小写字母，1个数字，1个特殊字符" placement="right">
            <el-input placeholder="密码" v-model="password" show-password @focus="controlMes()"></el-input>
          </el-tooltip>
        </div>
        <div class="regbox4">
          <div class="regbox4_1">
